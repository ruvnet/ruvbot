...
interface Message {
  id: string;
  content: string | JSX.Element[]; // Allowing for JSX.Element array
  role: string;
}
...
export default function ChatSection() {
  const {
    ...
    reload,
    stop,
    sessionId, // Adding sessionId for session handling
  ...
  }, [messages, sessionId]); // Add sessionId to useEffect dependencies
